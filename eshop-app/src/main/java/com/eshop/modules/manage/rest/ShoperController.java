...
package com.eshop.modules.manage.rest;
...
import com.eshop.modules.manage.param.OrderPriceParam;
import com.eshop.modules.manage.param.ShoperQueryParam;
import com.eshop.modules.order.param.OrderDeliveryParam;
import com.eshop.modules.order.param.OrderRefundParam;
...
public class ShoperController {
    ...
    public ApiResult<List<StoreOrderQueryVo>> orderList(ShoperQueryParam queryParam) {
    ...
    public ApiResult<StoreOrderQueryVo> orderDetail(@PathVariable String key){
        ...
        StoreOrderQueryVo storeOrder = storeOrderService.getOrderInfo(key,null);
